...
?>
    ...
    <section class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    ...
                    <a href="anuncio.php" class="boton-azul-block">
                        Ver Propiedad
                    </a>
        ...
        <div class="alinear-derecha">
            <a href="anuncios.php" class="boton-azulfuerte">Ver Todas</a>
        </div>
    </section>
    ...
    <section class="imagen-contacto">
        ...
        <a href="contacto.php" class="boton-azul">Contactanos</a>
    </section>
    ...
    <div class="contenedor seccion seccion-inferior">
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p>
                            Consejos para contruir la terraza de tu casa con los mejores materiales y ahorrando dinero
                        </p>
                    </a>
                </div>
            </article> 
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el <span> 14/07/22</span> por <span>Admin</span></p>

                        <p>
                            Maximiza el espacio en tu hogar con esta guia, aprende a combinar muebles y colores para darle vida a tu espaacio
                        </p>
                    </a>
                </div>
            </article> 
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se comporto de una excelente forma, muy buyena tencon y la casa que me ofrecieron cumple con todas mis expectativas.
                </blockquote>
                <p>-Example</p>
            </div>
        </section>
